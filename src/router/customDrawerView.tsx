...
import getDrawerStatusFromState from '@react-navigation/drawer/src//utils/getDrawerStatusFromState';
...
import { GestureHandlerRootView } from '@react-navigation/drawer/src/views/GestureHandler';
import {
	MaybeScreen,
	MaybeScreenContainer,
} from '@react-navigation/drawer/src/views/ScreenFallback';
...
function DrawerViewBase({
	...
	const Drawer: React.ComponentType<DrawerProps> = useLegacyImplementation
		? require('@react-navigation/drawer/src/views/legacy/Drawer').default
		: require('@react-navigation/drawer/src/views/modern/Drawer').default;
...
export default function CustomDrawerView({ navigation, ...rest }: Props) {
	return (
		<SafeAreaProviderCompat>
